...
describe('Poloniex Public API', function () {
  describe('returnTicker', function () {
    it('requests returnTicker from the Poloniex API and returns a promise', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _returnTicker2.default)();
